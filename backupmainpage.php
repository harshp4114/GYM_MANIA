...
<body>
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($quantitydead == 0) {
      ...
      $sql = "INSERT INTO `addtocart`(`name`,`quantity`,`amount`,`price`,`flavour`,`image`,`weight`,`size`) VALUES('$namedead','$quantitydead','$amountdead','$pricedead','$flavourdead','$imagedead','$weightdead','$weightdead')";
      $result = mysqli_query($conn, $sql);
      if ($result == TRUE) {
        // echo "Item added to cart";
      } else {
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($quantitywrist == 0) {
      ...
      $sql = "INSERT INTO `addtocart`(`name`,`quantity`,`amount`,`price`,`flavour`,`image`,`weight`,`size`) VALUES('$namewrist','$quantitywrist','$amountwrist','$pricewrist','$flavourwrist','$imagewrist','$weightwrist','$weightwrist')";
      $result = mysqli_query($conn, $sql);
      if ($result == TRUE) {
        // echo "Item added to cart";
      } else {
