...
<body style="background-color:black;">
    ...
    if ($flagaddress == 1 && $flagphone == 1 && $flagpincode == 1 && $flagemail == 1) {
        ...
        elseif ($method == "Debit/Credit Card")
            header("Location: /GYMMANIA/card.php");
    } else {
