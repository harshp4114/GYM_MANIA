...
<body>
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    for ($i = 0; $i < mysqli_num_rows($result); $i++) {
      ...
      <form action="/GYMMANIA/gmcart.php" method="post">';
          ...
          style="font-size: 25px;font-family: Helvetica;color: lightgrey;">      <label for="updateweightpla">Weight  :   </label><select style="padding: 10px;font-family: \'Gill Sans\', \'Gill Sans MT\', Calibri, \'Trebuchet MS\', sans-serif;font-size: 20px;" name="updateweightpla" id="updateweightpla" onclick="updatePricedum()"><option value="2.5 kg pair" selected>2.5 kg pair</option><option value="5 kg pair">5 kg pair</option><option value="10 kg pair">10 kg pair</option><option value="15 kg pair">15 kg pair</option><option value="20 kg pair">20 kg pair</option></select>    Chosen weight : ' . $row['weight'] . ' kg pair</pre>';
            ...
            echo '<pre
            style="font-size: 25px;font-family: Helvetica;color: lightgrey;">      <label for="updateweightpla">Weight  :   </label><select style="padding: 10px;font-family: \'Gill Sans\', \'Gill Sans MT\', Calibri, \'Trebuchet MS\', sans-serif;font-size: 20px;" name="updateweightpla" id="updateweightpla" onclick="updatePricedum()"><option value="2.5 kg pair">2.5 kg pair</option><option value="5 kg pair" selected>5 kg pair</option><option value="10 kg pair">10 kg pair</option><option value="15 kg pair">15 kg pair</option><option value="20 kg pair">20 kg pair</option></select>    Chosen weight : ' . $row['weight'] . ' kg pair</pre>';
          } elseif ($row['weight'] == "10") {
            echo '<pre
                style="font-size: 25px;font-family: Helvetica;color: lightgrey;">      <label for="updateweightpla">Weight  :   </label><select style="padding: 10px;font-family: \'Gill Sans\', \'Gill Sans MT\', Calibri, \'Trebuchet MS\', sans-serif;font-size: 20px;" name="updateweightpla" id="updateweightpla" onclick="updatePricedum()"><option value="2.5 kg pair">2.5 kg pair</option><option value="5 kg pair">5 kg pair</option><option value="10 kg pair" selected>10 kg pair</option><option value="15 kg pair">15 kg pair</option><option value="20 kg pair">20 kg pair</option></select>    Chosen weight : ' . $row['weight'] . ' kg pair</pre>';
          } elseif ($row['weight'] == "15") {
            echo '<pre
                    style="font-size: 25px;font-family: Helvetica;color: lightgrey;">      <label for="updateweightpla">Weight  :   </label><select style="padding: 10px;font-family: \'Gill Sans\', \'Gill Sans MT\', Calibri, \'Trebuchet MS\', sans-serif;font-size: 20px;" name="updateweightpla" id="updateweightpla" onclick="updatePricedum()"><option value="2.5 kg pair">2.5 kg pair</option><option value="5 kg pair">5 kg pair</option><option value="10 kg pair">10 kg pair</option><option value="15 kg pair" selected>15 kg pair</option><option value="20 kg pair">20 kg pair</option></select>    Chosen weight : ' . $row['weight'] . ' kg pair</pre>';
          } elseif ($row['weight'] == "20") {
            echo '<pre
                        style="font-size: 25px;font-family: Helvetica;color: lightgrey;">      <label for="updateweightpla">Weight  :   </label><select style="padding: 10px;font-family: \'Gill Sans\', \'Gill Sans MT\', Calibri, \'Trebuchet MS\', sans-serif;font-size: 20px;" name="updateweightpla" id="updateweightpla" onclick="updatePricedum()"><option value="2.5 kg pair">2.5 kg pair</option><option value="5 kg pair">5 kg pair</option><option value="10 kg pair">10 kg pair</option><option value="15 kg pair">15 kg pair</option><option value="20 kg pair" selected>20 kg pair</option></select>    Chosen weight : ' . $row['weight'] . ' kg pair</pre>';
          }
          echo '<pre
    ...
    $sqlselecttotal="SELECT `totalprice` FROM `total`";
    $selecttotalresult=mysqli_query($conn,$sqlselecttotal);
    $totalrow=mysqli_num_rows($selecttotalresult);
    if($totalrow>=1){}else{
      $alterSql = "INSERT INTO `total`(`totalprice`) VALUES ('$totalprice')";
      if (mysqli_query($conn, $alterSql)) {
          // echo "Column inserted successfully.";
      }
    }
    
    $sqltotal = "UPDATE `total` SET `totalprice`='$totalprice' ";
    $totalresult=mysqli_query($conn,$sqltotal);

    
    echo '<hr><br><pre style="font-size: 35px;font-family: Helvetica;color: lightgrey;text-align:center;">TOTAL PRICE : Rs. ' . number_format($totalprice) . '.00</pre>';
    echo '<ul style="list-style-type: none;margin: 0;padding: 0;overflow: hidden;background-color: #333;">
    <li style="display:block;"><a id="a" href="payment.php">PROCEED PAYMENT</a></li>
</ul>';
